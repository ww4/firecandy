...
(let* (;; Variable pitch
       ...
       (terminal-monokai-emphasis         "#FFFAFA")
  ...
  (custom-theme-set-faces
   ...
   `(font-latex-italic-face
     ((,class (:inherit italic :foreground ,monokai-emphasis))
      (,terminal-class (:inherit italic :foreground ,terminal-monokai-emphasis))))
